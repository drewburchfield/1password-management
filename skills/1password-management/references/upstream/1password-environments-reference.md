...
Supplement to [SKILL.md](1password-environments.md). Use for setup, mount conflicts, and shell
validation behavior.
...
and values, then use MCP tools per [SKILL.md](1password-environments.md).
